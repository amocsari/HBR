...
namespace DAL.Migrations
{
    ...
    [Migration("20190520003055_userseed")]
            ...
            modelBuilder.Entity("DAL.Entity.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 607, DateTimeKind.Local).AddTicks(6498),
                            PageNumber = 248,
                        ...
                        new
                        {
                            ...
                            Extension = "pdf",
                            GenreId = "95ea0beb-e05b-4dcf-a4cb-a91cce095d19",
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 607, DateTimeKind.Local).AddTicks(9184),
                            PageNumber = 249,
                        ...
                        new
                        {
                            ...
                            Extension = "pdf",
                            GenreId = "95ea0beb-e05b-4dcf-a4cb-a91cce095d19",
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 607, DateTimeKind.Local).AddTicks(9223),
                            PageNumber = 250,
                        ...
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 607, DateTimeKind.Local).AddTicks(9239),
                            PageNumber = 195,
            ...
            modelBuilder.Entity("DAL.Entity.Bookmark", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = "466a182c-dd53-4c27-affb-75fb4ff6e220",
                            Deleted = false,
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 608, DateTimeKind.Local).AddTicks(2684),
                            PageNumber = 25,
                        ...
                        new
                        {
                            ...
                            BookId = "3cfb0d9e-1c37-499d-9271-0dd7b17400d3",
                            Deleted = false,
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 608, DateTimeKind.Local).AddTicks(4331),
                            PageNumber = 37,
                            UserIdentifier = "87d92da2-13df-47d5-85d7-b3f0fc3d99ba"
                        },
                        new
                        {
                            ...
                            BookId = "b8c55736-422e-49d3-9dc3-d406bdd53d8c",
                            Deleted = false,
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 608, DateTimeKind.Local).AddTicks(4361),
                            PageNumber = 48,
                            UserIdentifier = "87d92da2-13df-47d5-85d7-b3f0fc3d99ba"
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entity.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Deleted = false,
                            GenreName = "Fantasy",
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 605, DateTimeKind.Local).AddTicks(5670)
                        },
                        new
                        {
                            GenreId = "7a4f9a69-3afd-4dae-829a-ae4691a415db",
                            Deleted = false,
                            GenreName = "Sci-Fi",
                            LastUpdated = new DateTime(2019, 5, 20, 2, 30, 55, 607, DateTimeKind.Local).AddTicks(1445)
                        });
                });
